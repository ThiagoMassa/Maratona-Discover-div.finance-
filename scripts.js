...
const Utils = {
    formatAmount(value) {
        ...
        // poderia deixar  value = Number(value.replace(/\,\./g, "")) * 100
...
const Form = {
    ...
    saveTransaction(transaction){
        ...
        // poderia deixar direto dentro do TRY pois é 1 linnha so
    },
    clearFields(){
    ...
    submit(event) {
        ...
        try {
            ...
            Form.saveTransaction(transaction) // poderia ficar  "Transactions.add(transaction)"
            Form.clearFields()
            Modal.close()
        } catch (error) {
            alert(error.message)
